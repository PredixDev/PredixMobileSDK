...
The Predix Mobile Reference App for iOS, you build the [Predix Mobile App Container for iOS](https://github.com/PredixDev/PredixMobileReferenceApp), a platform-specific environment in which Predix mobile applications are run. It contains an implementation of the Predix Mobile Client Core Services framework. 
