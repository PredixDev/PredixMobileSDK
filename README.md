...
1. WEB-APPs
  ...
  * [MobileExample-WebApp-AssetIntegration : Sample webapp which sends a test command to Mobile Service and displays the response. example](https://github.com/PredixDev/MobileExample-WebApp-AssetIntegration)  
